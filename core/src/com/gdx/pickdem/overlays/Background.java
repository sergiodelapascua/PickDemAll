...
public class Background extends Actor {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        for(int i = 0;i<layers.size;i++) {
            ...
            batch.draw(layers.get(i), 0, 0, originX, originY, width/3.4f, heigth/3.4f,scaleX,scaleY,rotation,srcX,srcY,layers.get(i).getWidth(),layers.get(i).getHeight(),flipX,flipY);
        }
    }
}
